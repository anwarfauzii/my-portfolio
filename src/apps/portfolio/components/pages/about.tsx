    ...
    <div className="w-full h-full flex flex-col justify-center px-20">
      ...
      <div className="flex items-center">
        ...
        <p className="pt-6 text-base font-normal pr-48 pl-24 text-gray-300">
          ...
          other sources such as YouTube, Udemy Courses, Dicoding, and Blogs to expand my skills.
          <br /> <br />
          The world of software development offers a vast array of things to learn and numerous
